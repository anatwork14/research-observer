...
export function ResearchNav({ entries, activeSlug }: { entries: Item[]; activeSlug: string }) {
  ...
  return (
    <aside className="left-rail panel">
      ...
      <nav className="progress-list" aria-label="Research progress">
        {visible.map((entry) => (
      ...
      <p className="rail-tip"><code>XX_name.md</code> controls ordering automatically.</p>
    </aside>
  );
}
